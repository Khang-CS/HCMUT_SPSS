        ...
        <div class="container">
            <div class="row g-4 listRow">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 printerCol">
                    <form action="" class="printer" method="post" enctype="multipart/form-data"
                        onsubmit="return confirmAction('delete printer')">
                        ...
                        <input name="printerID" type="text" value="<?php echo $printer->printerID; ?>" hidden>
                        <a href="<?php echo '/index.php?controller=pages&action=viewAndEdit&printerID=' . $printer->printerID; ?>"
                            class="moreButton">MORE</a>
                        <input name="deletePrinter" type="submit" class="deleteButton" value="DEL">
                    </form>
                </div>
                <?php
                    }
