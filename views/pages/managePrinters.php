...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary navigationBar">
        <div class="container-fluid">
            <a class="navbar-brand" href="home.html">HCMT SPSO</a>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <div class="ml-auto">
                    ...
                    <a class="nav-link logoutButton" href="login.html">Logout <i
    ...
    <section class="homePage">
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-6 featureManagePrinters">
                    <div class="featureManagePrintersContent">
                        <h2><a href="newPrinter.html" class="">ADD NEW PRINTER</a></h2>
                    </div>
                </div>
            </div>

        </div>
        <a href="" class="commonButton">GO BACK</a>
